...
class toSymbol(commands.Converter):
    async def convert(self, ctx, argument):
        filt = DIGITAL_CURRENCY_LIST['currency name'].str.contains(rf'^{argument}$', flags=re.IGNORECASE)
...
class Crypto(commands.Cog):
    ...
    async def test(self, ctx):
        embed = discord.Embed(title='Test', description='Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem', color=0x00ff00)
